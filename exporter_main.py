...
# Track consecutive PSU status fetch failures to avoid immediately marking sensors as failed
psu_status_failures = {}
    ...
    for psu in psus:
        ...
        for i in range(1, 13):
            ...
            try:
                ...
                psu_status_failures[sensor_key] = 0
            except Exception as e:
                failure_count = psu_status_failures.get(sensor_key, 0) + 1
                psu_status_failures[sensor_key] = failure_count
                if failure_count >= 2:
                    powershelf_psu_fail.labels(
                        sensor_name=f"PSU_{i}",
                        rack_name=rack_name,
